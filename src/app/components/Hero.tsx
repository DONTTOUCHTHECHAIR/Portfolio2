...
export function Hero() {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 px-4 py-16 md:py-24 relative">
      <div className="max-w-4xl w-full">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            <Button size="lg" className="gap-2 cursor-pointer" onClick={() => handleButtonClick('experience')}>
              View My Work
              <ArrowRight className="size-4" />
            </Button>
            <Button size="lg" variant="outline" className="cursor-pointer" onClick={() => handleButtonClick('about')}>
              Get In Touch
            </Button>
          </div>
        </div>
      ...
      {/* Scroll Indicator */}
      <div className={`absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-slate-400 transition-opacity duration-300 ${
